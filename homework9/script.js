...
//         // console.log(`desired keys`, desiredKeys)         // desiredKeys[1] - position
//         const res = [];                                     // desiredKeys.length = 2
        
//         for(let object of array){
//             res.push(object);
//             for(i = 0; i < desiredKeys.length; i++){
//                 // console.log('test', object[desiredKeys[i]] !== desiredObject[desiredKeys[i]])

//                 if(object[desiredKeys[i]] !== desiredObject[desiredKeys[i]]){
//                     res.splice(res.indexOf(object),1)
//                 }
//             }
//         }
//         console.log(res)
...
// filteredData(data, { position: "middle", name: "Sally" });
